          ...
          <ul class="glide__slides">
            <li class="glide__slide">
              <div class="slide__content">
                <img src="/build/img/nissi-index.webp" alt="nissi-confecciones">
              </div>
            </li>
            <li class="glide__slide">
              <div class="slide__content">
                <img src="/build/img/nissi-index2.webp" alt="nissi-confecciones">
              </div>
            </li>
            <li class="glide__slide">
              <div class="slide__content">
                <img src="/build/img/nissi-index3.webp" alt="nissi-confecciones">
              </div>
            </li>
            <li class="glide__slide">
              <div class="slide__content">
                <img src="/build/img/nissi-about.webp" alt="nissi-confecciones">
              </div>
            </li>
            <li class="glide__slide">
              <div class="slide__content">
                <img src="/build/img/nissi-galery1.webp" alt="nissi-confecciones">
              </div>
            </li>
            <li class="glide__slide">
              <div class="slide__content">
                <img src="/build/img/nissi-galery2.webp" alt="nissi-confecciones">
              </div>
            </li>
            <li class="glide__slide">
              <div class="slide__content">
                <img src="/build/img/nissi-products.webp" alt="nissi-confecciones">
              </div>
            </li>
            <li class="glide__slide">
              <div class="slide__content">
                <img src="/build/img/nissi-product.webp" alt="nissi-confecciones">
              </div>
            </li>
          </ul>
        </div>
      ...
      <div class="glide glide2">
        ...
        <div class="glide__track" data-glide-el="track">
          <ul class="glide__slides">
            <li class="glide__slide">
              <div class="slide__content">
                <img src="/build/img/uptask-login.webp" alt="UpTask">
              </div>
            </li>
            <li class="glide__slide">
              <div class="slide__content">
                <img src="/build/img/uptask-index.webp" alt="UpTask">
              </div>
            </li>
            <li class="glide__slide">
              <div class="slide__content">
                <img src="/build/img/uptask-tasks.webp" alt="UpTask">
              </div>
            </li>
            <li class="glide__slide">
              <div class="slide__content">
                <img src="/build/img/uptask-profile.webp" alt="UpTask">
              </div>
            </li>
            <li class="glide__slide">
              <div class="slide__content">
                <img src="/build/img/uptask-createProyect.webp" alt="nissi-confecciones">
              </div>
            </li>
          </ul>
        </div>
      ...
      <div class="glide glide3">
        ...
        <div class="glide__track" data-glide-el="track">
          <ul class="glide__slides">
            <li class="glide__slide">
              <div class="slide__content">
                <img src="/build/img/appsalon-login.webp" alt="AppSalon">
              </div>
            </li>
            <li class="glide__slide">
              <div class="slide__content">
                <img src="/build/img/appsalon-index.webp" alt="AppSalon">
              </div>
            </li>
            <li class="glide__slide">
              <div class="slide__content">
                <img src="/build/img/appsalon-dateInfo.webp" alt="AppSalon">
              </div>
            </li>
            <li class="glide__slide">
              <div class="slide__content">
                <img src="/build/img/appsalon-summary.webp" alt="AppSalon">
              </div>
            </li>
          </ul>
        </div>
...
$script = '
  ...
  <script src="/build/js/carrouselProyects.js"></script>
';
